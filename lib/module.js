...
var formatCell = (cell, index, rowIndex, styles) => {
...
<Override ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.styles+xml" PartName="/styles.xml"/>
</Types>`;
...
var defaultStyles = `<fonts count="1">
<font />
</fonts>
<fills count="1">
<fill />
...
var styleTemplate = `<?xml version="1.0" encoding="utf-16" standalone="yes"?>
<styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">{placeholder}</styleSheet>`;
